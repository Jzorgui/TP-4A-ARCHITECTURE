...
public class MarsRoverImp implements MarsRover {
	...
	/* MapRange */private int xMaxMap, yMaxMap, xMinMap, yMinMap;
	/* Constructors */public MarsRoverImp(String name) { this.name = name; }
	public MarsRoverImp() { }
	/* Getters and Setters */public void setDirection(Direction direction) { this.direction=direction; }
	public void setLocalMap(LocalMap localMap) { this.localMap = localMap; }
	public LocalMap getLocalMap() { return this.localMap; }
	...
	public int getLazerRange() { return lazerRange; }
	public boolean getStatus() { return status; }
	public void setStatus(boolean status) { this.status = status; }
	public int getX() { return x; }
	public int getY() { return y; }
	public int getxMaxMap() { return xMaxMap; }
	public int getyMaxMap() { return yMaxMap; }
	public int getxMinMap() { return xMinMap; }
	public int getyMinMap() { return yMinMap; }
	// Functions
	@Override
